...
# LoadRunner Function Dictionary (for easy access in generators)
LR_FUNCTIONS = {
    'VUSER_INIT': LR_VUSER_INIT,
    'ACTION': LR_ACTION,
    'VUSER_END': LR_VUSER_END,
    'WEB_URL': LR_WEB_URL,
    'WEB_SUBMIT_DATA': LR_WEB_SUBMIT_DATA,
    'WEB_CUSTOM_REQUEST': LR_WEB_CUSTOM_REQUEST,
    'WEB_ADD_HEADER': LR_WEB_ADD_HEADER,
    'WEB_ADD_COOKIE': LR_WEB_ADD_COOKIE,
    'WEB_SET_COOKIE': LR_WEB_SET_COOKIE,
    'WEB_REG_SAVE_PARAM': LR_WEB_REG_SAVE_PARAM,
    'WEB_REG_SAVE_PARAM_JSON': LR_WEB_REG_SAVE_PARAM_JSON,
    'WEB_REG_SAVE_PARAM_XPATH': LR_WEB_REG_SAVE_PARAM_XPATH,
    'WEB_REG_FIND': LR_WEB_REG_FIND,
    'LR_THINK_TIME': LR_THINK_TIME,
    'LR_START_TRANSACTION': LR_START_TRANSACTION,
    'LR_END_TRANSACTION': LR_END_TRANSACTION,
    'LR_SAVE_STRING': LR_SAVE_STRING,
...
# Error Code Dictionary (for easy access in converters)
ERROR_CODES = {
    'INVALID_FILE': f"ERR{ERROR_INVALID_FILE}",
    'FILE_TOO_LARGE': f"ERR{ERROR_FILE_TOO_LARGE}",
    'INVALID_FORMAT': f"ERR{ERROR_INVALID_FORMAT}",
    'INVALID_XML': f"ERR{ERROR_INVALID_FORMAT}",
    'PARSING_FAILED': f"ERR{ERROR_PARSING_FAILED}",
    'CONVERSION_ERROR': f"ERR{ERROR_CONVERSION_FAILED}",
    'GENERATION_FAILED': f"ERR{ERROR_GENERATION_FAILED}",
    'UNSUPPORTED_ELEMENT': f"ERR{ERROR_UNSUPPORTED_ELEMENT}",
    'VALIDATION_FAILED': f"ERR{ERROR_VALIDATION_FAILED}",
    'MISSING_REQUIRED_FIELD': f"ERR{ERROR_VALIDATION_FAILED}"
}

# JMeter Elements Dictionary (for easy access in parsers)
JMETER_ELEMENTS = {
    'TEST_PLAN': JMETER_TEST_PLAN,
    'THREAD_GROUP': JMETER_THREAD_GROUP,
    'HASH_TREE': JMETER_HASH_TREE,
    'HTTP_SAMPLER': JMETER_HTTP_SAMPLER,
    'HTTP_SAMPLER_OLD': JMETER_HTTP_SAMPLER_OLD,
    'HEADER_MANAGER': JMETER_HEADER_MANAGER,
    'COOKIE_MANAGER': JMETER_COOKIE_MANAGER,
    'REGEX_EXTRACTOR': JMETER_REGEX_EXTRACTOR,
    'JSON_EXTRACTOR': JMETER_JSON_EXTRACTOR,
    'RESPONSE_ASSERTION': JMETER_RESPONSE_ASSERTION,
    'CONSTANT_TIMER': JMETER_CONSTANT_TIMER,
    'UNIFORM_RANDOM_TIMER': JMETER_UNIFORM_RANDOM_TIMER,
    'LOOP_CONTROLLER': JMETER_LOOP_CONTROLLER,
    'IF_CONTROLLER': JMETER_IF_CONTROLLER,
    'WHILE_CONTROLLER': JMETER_WHILE_CONTROLLER,
    'TRANSACTION_CONTROLLER': JMETER_TRANSACTION_CONTROLLER,
    'USER_DEFINED_VARIABLES': JMETER_USER_DEFINED_VARIABLES
}
